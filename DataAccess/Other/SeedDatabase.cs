...
namespace DataAccess.Other
{
	public static class SeedDatabase
	{
		private static FoodName[] FoodNames => new[] {
			...
			new FoodName(1, 3) {Name = "Kuře na paprice", Type = 1, Categories = new[] {3, 5, 9},},
			...
			new FoodName() {Name = "Šunkofleky", Type = 1, Categories = new[] {3, 5},},
			new FoodName() {Name = "Zapečené brambory", Type = 1, Categories = new[] {3, 5},},
			...
			new FoodName(1, 2) {Name = "Holandský řízek", Type = 1, Categories = new[] {3, 5},},
			new FoodName() {Name = "Halušky", Type = 1, Categories = new[] {3, 5},},
			new FoodName() {Name = "Špagety", Type = 1, Categories = new[] {3, 6},},
			new FoodName() {Name = "Těstoviny s tuňákem", Type = 1, Categories = new[] {3, 6},},
